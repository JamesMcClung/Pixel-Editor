...
public class Enabler {
	...
	/**
	 * Adds the given enableables and conditions as a single pair.
	 * When {@link Enabler#updateEnableds()} is called, all of the given conditions will be checked.
	 * Then, all of the given enableables will be set to the conjunction of the conditions.
