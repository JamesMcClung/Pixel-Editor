...
public class SpritesheetManager extends JPanel {
	...
	public SpritesheetManager(App app) {
		...
		// Panels
		GBC.addComp(this::add, 0, 0, previewPanel, new GBC().dim(1, 2).fill(GBC.BOTH).weight(1, 1),
		...
		enabler.add(hasSheet, spriteWidthField::setEnabled, spriteHeightField::setEnabled, lbutton::setEnabled,
				rbutton::setEnabled, playButton::setEnabled, clearButton::setEnabled);
		enabler.add(new Enabler.Enableable[] { lbutton::setEnabled, rbutton::setEnabled },
	...
	/**
	 * Parses and returns the user's entries in the text fields specifiying sprite dimensions. Returns (-1, -1) if
	 * either entry is not an integer.
	 * 
	...
	/**
	 * Updates the manager's fields etc. to align with the given spritesheet being active. DOES NOT update any other app
	 * components.
	 * 
