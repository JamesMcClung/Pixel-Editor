...
public class IOUtil {
	...
	/**
	 * Saves the given spritesheet to the given file as an animated gif. Each nonempty sprite is added the gif in order.
	 * 
	...
	/**
	 * Adds a transparent pixel in the bottom-right corner encoding the given dimensions. Specifically, alpha is 0, the
	 * first 12 bits store height, and the next 12 bits store width.
	 * 
	...
	/**
	 * Reads the hidden information encoded in the bottom-right corner of the spritesheet image. Returns null if no such
	 * information exists.
	 * 
	 * @param image a spritesheet image
